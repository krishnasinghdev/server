...
const baseUrl = "https://dodopayments.com"

export default function StripeWelcomeEmail({ user, url }: StripeWelcomeEmailProps) {
      ...
      <Body style={main}>
        ...
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>First, confirm your email so we can unlock everything in your dashboard.</Text>
